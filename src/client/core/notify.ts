...
export function notifySuccess(message: string, title?: string) {
  ...
  notifications.show({ title: ttl, message, color: 'green', autoClose: 3000, withCloseButton: true, style: { pointerEvents: 'auto' } });
}
...
export function notifyInfo(message: string, title?: string) {
  ...
  notifications.show({ title: ttl, message, color: 'blue', autoClose: 3000, withCloseButton: true, style: { pointerEvents: 'auto' } });
}
